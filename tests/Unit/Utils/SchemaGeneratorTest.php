...
use PhpMcp\Server\Tests\Fixtures\Utils\SchemaAttributeFixture;
use PhpMcp\Server\Tests\Fixtures\Utils\DockBlockParserFixture;
...
test('generates schema for required simple types', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'simpleRequired');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for optional simple types with defaults', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'simpleOptionalDefaults');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for nullable types without explicit default', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'nullableWithoutDefault');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for nullable types with explicit null default', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'nullableWithNullDefault');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for array types', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'arrayTypes');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for enum types', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'enumTypes');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for variadic parameters', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'variadicParam');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema for mixed type', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'mixedType');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema using docblock type overriding php type hint', function () {
    $method = new ReflectionMethod(SchemaGeneratorFixture::class, 'docBlockOverrides');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema with string format constraints from Schema attribute', function () {
    $method = new ReflectionMethod(SchemaAttributeFixture::class, 'stringConstraints');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema with numeric constraints from Schema attribute', function () {
    $method = new ReflectionMethod(SchemaAttributeFixture::class, 'numericConstraints');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema with array constraints from Schema attribute', function () {
    $method = new ReflectionMethod(SchemaAttributeFixture::class, 'arrayConstraints');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema with object constraints from Schema attribute', function () {
    $method = new ReflectionMethod(SchemaAttributeFixture::class, 'objectConstraints');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('generates schema with nested constraints from Schema attribute', function () {
    $method = new ReflectionMethod(SchemaAttributeFixture::class, 'nestedConstraints');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('respects precedence order between PHP type, DocBlock, and Schema attributes', function () {
    $method = new ReflectionMethod(SchemaAttributeFixture::class, 'typePrecedenceTest');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('parses simple array[] syntax correctly', function () {
    $method = new ReflectionMethod(DockBlockParserFixture::class, 'simpleArraySyntax');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('parses array<T> generic syntax correctly', function () {
    $method = new ReflectionMethod(DockBlockParserFixture::class, 'genericArraySyntax');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('parses nested array syntax correctly', function () {
    $method = new ReflectionMethod(DockBlockParserFixture::class, 'nestedArraySyntax');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
...
test('parses object-like array syntax correctly', function () {
    $method = new ReflectionMethod(DockBlockParserFixture::class, 'objectArraySyntax');
    setupDocBlockExpectations($this->docBlockParserMock, $method);
